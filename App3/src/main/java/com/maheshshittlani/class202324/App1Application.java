...
import com.maheshshittlani.util.sorting.BubbleSort;
import com.maheshshittlani.util.sorting.SelectionSort;
...
public class App1Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(context.getBean(BubbleSort.class));
		System.out.println(context.getBean(	BubbleSort.class));
		System.out.println(context.getBean(BubbleSort.class));
		System.out.println(context.getBean(BubbleSort.class));
		...
		System.out.println(context.getBean(SelectionSort.class));
		System.out.println(context.getBean(SelectionSort.class));
		System.out.println(context.getBean(SelectionSort.class));
		System.out.println(context.getBean(SelectionSort.class));
	}
